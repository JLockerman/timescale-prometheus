...
func (m *WriteRequest) Unmarshal(dAtA []byte) error {
	...
	if cap(m.Timeseries) < numTimeseries {
		newTimeseries := make([]TimeSeries, len(m.Timeseries), numTimeseries)
		copy(newTimeseries, m.Timeseries)
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, _ := skipRemote(dAtA[iNdEx:])
